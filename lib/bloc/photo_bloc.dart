...
class PhotoBloc extends Bloc<PhotoEvent, PhotoState> {
  ...
  FutureOr<void> _onGetPhotos(EventGetPhotos event, Emitter<PhotoState> emit) async{
    ...
    if (response.statusCode == 200) {
      if (parsedJson is List) {
        ...
        emit(StateDidReceivePhotos(parsedJson.map((e) => PhotosModel.fromJson(e)).toList()));
      }
